    ...
    while(True):
        ...
        if cnc == "layer7" or cnc == "LAYER7" or cnc == "L7" or cnc == "l7":
            ...
            try:
                ...
                print(Fore.RED +'Usage: crash <url> METHODS<GET/POST>')
                print(Fore.RED +'Example: crash http://example.com GET')
            ...
            try:
                ...
                print(Fore.RED +'Usage: httpflood <url> <threads> METHODS<GET/POST> <time>')
                print(Fore.RED +'Example: httpflood http://example.com 15000 get 60')
